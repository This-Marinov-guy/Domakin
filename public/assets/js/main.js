    ...
    jQuery(document).ready(function () {
        ...
        */
        ...
        $(document).ready(function () {
            $('.button-renting').click(function () {
                setTimeout(function () {
                    $('html, body').animate({
                        scrollTop: $('#form-renting').offset().top - 120
                    }, 100); // Adjust the animation speed as needed (in milliseconds)
                }, 200); // Delay the scroll animation by 2000 milliseconds (2 seconds)
