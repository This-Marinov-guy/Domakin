const BG = {
    ...
    team: [
        ...
        'Нашите агенти',
        {
            ...
            aboutExtra: 'Здравейте, казвам се Лазар и живея в Грьонинген вече пета година. Познавам градът добре и запознат с намирането и предлагането на имоти в околността, което ме прави идеален за услугите на организацията. Моите интереси са предимно бойни спортове и изкуствен интелект, както менажиране на няколко организации и сдружения. Надявам се да ви бъда от огромна полза!'
        },
        {
            name: 'Сава Попов',
            position: 'Агент за огледи/ Дизайнер',
            about: '20, Студент по Дизайн на Игри',
            aboutExtra: 'Здравейте, аз съм Сава и съм студент по дизайн на видео игри тук в Гронинген. За мен беше изключително трудно да си наема жилище в града и знам какво направих грешно и какво направих добре. Готов съм да предам опита си на тези, които тепърва започват да търсят квартири/стаи в града. Ще се радвам да ви бъда от полза!'
        },
        {
