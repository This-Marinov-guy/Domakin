const BG = {
    ...
    privacyPolicyContent: [
        "Правни",
        "Условия и политика",
        "Дата на влизане в сила: 1ви август 2023 г.",
        "В Домакин ние се стремим да защитаваме вашата лична информация и да гарантираме сигурността й. Тази Политика за поверителност описва как събираме, използваме и обезпечаваме вашите данни, докато използвате нашата платформа за намиране на настаняване в Нидерландия. Като получите достъп и използвате уебсайта или мобилното приложение на Домакин (наречено \"Платформа\"), вие давате съгласието си на практиките, описани в тази Политика за поверителност.",
        "1. Информация, която събираме",
        "Можем да събираме различни видове информация от вас, включително, но не само: Лична информация: Вашето име, имейл адрес, телефонен номер и други контактни данни.\nИнформация за профила: Подробности за вашите предпочитания, интереси и изисквания за настаняване.\nИнформация за кореспонденция: Записи на кореспонденцията между вас и Домакин.\nИнформация за употреба: Данни за вашия взаимодействия с Платформата, като търсения, разглеждани обяви и потребителски взаимодействия. Декларации за семейство и доходи: Някои данни за вашето семейство, техния доход, личен доход и всяка друга финансова информация, която може да бъде поискана от наемодател или страна, която изисква това единствено за цели, свързани с предоставяне на настаняване.",
        "2. Как използваме вашата информация",
        "Използваме събраната информация за следните цели: За улеснение на използването на Платформата и предоставяне на персонализирани услуги.\nЗа съответствие с вас с подходящи обяви за настаняване, основани на вашия вкус.\nЗа подобряване на услугите ни, потребителското изживяване и поддръжката на клиенти.\nЗа комуникация с вас относно вашия профил, обяви и свързани актуализации.\nЗа анализ на потребителските поведения и провеждане на изследвания с цел подобряване на предложенията ни.",
        "3. Споделяне на информация",
        "Можем да споделяме вашата информация в следните случаи: С настанителните обекти: Информацията от вашия профил може да бъде споделена със собствениците на настанителни обекти за целите на резервацията и комуникацията.\nС трети доставчици на услуги: Можем да ангажираме доверени трети страни, за да ни помогнат в предоставянето на услуги, като обработка на плащания или анализ на данни. Съответствие със законовите изисквания: Можем да разкрием информация, ако това се изисква от закона или за защита на нашите права, поверителност, безопасност, собственост или на други хора.",
        "4. Вашите избори",
        ...
        "Можем да актуализираме тази Политика за поверителност, по мерка както се развиват нашите практики, така и при изменение на законовите изисквания. Всякакви промени ще бъдат публикувани на Платформата, и продължаването ви на използване на Платформата след такива промени означава вашето одобрение на актуализираната политика.",
        "8. Контакти",
        "Ако имате въпроси, опасения или заявления, свързани с поверителността ви, моля, свържете се с нас на [контактен имейл/телефон].",
        "Благодарим ви, че доверявате на Домакин за вашето търсене на настаняване. Ние сме посветени на гарантирането на вашата поверителност и предоставяне на сигурно и удобно изживяване на нашата платформа.",
        'Контакти'
    ],
