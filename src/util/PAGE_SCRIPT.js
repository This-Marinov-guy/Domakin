const BG = {
    ...
    team: [
        ...
        'Нашите агенти',
        {
            ...
            aboutExtra: 'Здравейте, казвам се Лазар, от Русе, но живея в Грониген вече пета година. Познавам градът добре и съм запознат с търсенето и намирането на жилища под наем. Моите интереси са бойни спортове и изкуствен интелект, както съм президент и съосновател на студентската non-profit организация Bulgarian Society Gronigen. Ще се радвам да съм Ви от помощ!'
        },
        {
            name: 'Сава Попов',
