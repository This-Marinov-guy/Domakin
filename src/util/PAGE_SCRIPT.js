const BG = {
    ...
    team: [
        ...
        },
        {
            ...
            about: '21, Студент по Менджмънт на Строителството',
            aboutExtra: `Здравейте, казвам се Константин и съм студент по мениджмънт на строителството. За мен също беше изключително трудно да се сдобия със стая в Грьонинген и бях изклютелно удовлетворен, когато намерих място с помощта на познати в града. Разбира се, и с тях намерих затруднения, заради огромния поток от клинети и скъпи тарифи. Ние от 'Домакин' гарантираме качествено обслужване и добри цени, защото за нас пръв приоритет е да помогнем на хората, които изпитват нашите трудностти. Очаквам да работим заедно!`
        },
        {
