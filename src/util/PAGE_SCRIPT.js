const BG = {
    ...
    emergency_housing: [
        ...
        'Ако все още не сте си намерили място в Холандия или може да се нанесете в квартирата си само на по-късна дата, може да се възползвате от настаняване, което други българи в града предлагат за кратък престой, като следвате стъпките: ',
        ` 1) Изберете опцията 'Търсене' по-долу`,
        '2) Изберете стая, като щракнете върху бутона за избор',
        '3) Попълнете данните си във формата, която ще се появи',
        ...
        ' Учебната година започва, но все още има студенти които имат нужда от настаняване. Ако имате свободен диван или стая, може да помогнете на българи, които все още не са намерили квартира като предложите временно настаняване следвате стъпките: ',
    ...
    FOR_RENT: [{
        ...
        description: {
            property: '9 кв метра. Регистрация е възможна!',
            period: '12-месечен договор',
            bills: 'сметките не са включени (около 120 евро)',
            flatmates: '3ма българи',
        },
        main_image: "assets/img/properties/property_10/1.jpeg",
    ...
    },
    {
        ...
        description: {
            property: 'Апартаментът е на два етажа, като двете спални плюс банята са на втория етаж, а кухнята, холя и тоалетната са на долния етаж. В близост има супермаркети, заведения, влак/метро и тн.',
            period: 'Свободна веднага',
            bills: 'около 80 евро месечни сметки',
            flatmates: '1 момиче (българка)',
        },
        ...
        images: ['assets/img/properties/property_5/2.jpg', 'assets/img/properties/property_5/3.jpg', 'assets/img/properties/property_5/4.jpg', 'assets/img/properties/property_5/5.jpg', 'assets/img/properties/property_5/6.jpg', 'assets/img/properties/property_5/7.jpg', 'assets/img/properties/property_5/8.jpg', 'assets/img/properties/property_5/9.jpg', 'assets/img/properties/property_5/10.jpg'],
    },
    {
        id: '4',
        status: 'Заета',
        ...
        description: {
            property: 'Студио в центъра на града, свободно за ползване докато наемателят е на обмен. Регистрация НЕ е възможна',
            period: '2ри Октомври 2023 - 2ри Март 2024',
            bills: 'Всички сметки са включени',
            flatmates: 'Няма съквартиранти',
        },
        main_image: "assets/img/properties/studio2/5.jpg",
        images: ['assets/img/properties/studio2/1.jpg', 'assets/img/properties/studio2/2.jpg', 'assets/img/properties/studio2/3.jpg', 'assets/img/properties/studio2/4.jpg', 'assets/img/properties/studio2/6.jpg', 'assets/img/properties/studio2/7.jpg', 'assets/img/properties/studio2/8.jpg', 'assets/img/properties/studio2/9.jpg', 'assets/img/properties/studio2/10.jpg', , 'assets/img/properties/studio2/11.jpg', , 'assets/img/properties/studio2/12.jpg'],
    },
    {
        id: '3',
        status: 'Заета',
    ...
    EMERGENCY_HOUSING: [
        {
            ...
            description: {
                ...
                flatmates: '4ма студенти съквартиранти',
    ...
    donations: [
        'Вашата помощ значи много за нас!',
        'Благодарим Ви',
        'Име (не задължително)',
        'Сума в Евро',
        'Вашето съобщение към нас (не задължително)',
        'Продължи',
        'Плати',
        'Извършване...',
        'Изникна грешка - моял опитайте отново !',
        'Сумата е отрицателна',
        'Минималната сума е 2 Евро',
        'Моля въведете сума',
    ],
    feedbacks: [
        'Подпомагане',
    ...
    privacyPolicyContent: [
        "Правни",
        "Условия и политика",
        "Дата на влизане в сила: 1 август 2023 г.",
        "В Domakin ние се стремим да защитаваме вашата поверителност и да гарантираме сигурността на вашата лична информация. Тази Политика за поверителност описва как събираме, използваме и обезпечаваме вашите данни, докато използвате нашата платформа за намиране на настаняване в Нидерландия. Като получите достъп и използвате уебсайта или мобилното приложение на Domakin (наречено \"Платформа\"), вие давате съгласието си на практиките, описани в тази Политика за поверителност.",
        "1. Информация, която събираме",
        "Можем да събираме различни видове информация от вас, включително, но не само: Лична информация: Вашето име, имейл адрес, телефонен номер и други контактни данни.\nИнформация за профила: Подробности за вашите предпочитания, интереси и изисквания за настаняване.\nИнформация за кореспонденция: Записи на кореспонденцията между вас и Domakin.\nИнформация за употреба: Данни за вашите взаимодействия с Платформата, като търсения, прегледани обяви и потребителски взаимодействия. Декларации за семейство и доходи: Някои данни за вашия семействен доход, личен доход и всяка друга финансова информация, която може да бъде изискана от наемодател или страна, която го изисква само за цели, свързани с настаняване.",
        "2. Как използваме вашата информация",
        "Използваме събраната информация за следните цели: За улеснение на използването на Платформата и предоставяне на персонализирани услуги.\nЗа съвместимост с подходящи обяви за настаняване, базирани на вашите предпочитания.\nЗа подобряване на нашите услуги, потребителското изживяване и поддръжката на клиенти.\nЗа комуникация с вас относно вашия профил, обяви и свързани актуализации.\nЗа анализ на образци на употреба и провеждане на изследвания с цел подобряване на нашите предложения.",
        "3. Споделяне на информация",
        "Можем да споделяме вашата информация в следните случаи: С настанителния обект: Информацията от вашия профил може да се споделя със собствениците на настанителни обекти, за да се улесни резервацията и комуникацията.\nС трети доставчици на услуги: Можем да ангажираме доверени трети страни, които да ни помагат в предоставянето на услуги, като обработка на плащания или анализ на данни. Съответствие със законовите изисквания: Можем да разкрием информация, ако това се изисква от закона или за защита на нашите права, поверителност, безопасност, собственост или на други хора.",
        "4. Вашият избор",
        "Можете да актуализирате и управлявате информацията в профила си и предпочитанията за комуникация в настройките на акаунта си. Отказване от комуникация: Можете да се откажете от получаването на определени съобщения от нас, следвайки инструкциите, предоставени в тези съобщения.",
        "5. Защита на данните",
        "Използваме стандартни мерки за сигурност, за да защитим вашите данни от неоторизиран достъп, разкриване, промяна или унищожение.",
        "6. Поверителност на децата",
        "Платформата не е предназначена за лица под 16-годишна възраст. Ние не събираме нарочно лична информация от непълнолетни без родителско съгласие.",
        "7. Сключване на договор",
        "За гарантиране на безопасността за двете страни, може да изискаме да попълните вашите данни и да подпишете договор, когато се включват финанси. Договорът може да бъде съхраняван и използван от нас за всички правни действия, които са необходими, ако една от страните не спазва изискванията, поставени от нея. Domakin гарантира предоставянето на копие на договора на клиента и на всяка друга страна, когато е получено и одобрено искане.",
        "Ако имате въпроси, опасения или заявления, свързани с поверителността ви",
        "Свържете се с нас",
    ]
}
...
const EN = {
    ...
    FOR_RENT: [{
        ...
        location: 'Petrus Driessenstraat, Groningen',
        description: {
            property: '9 sq meters. Registration is possible',
            period: '12 month contract',
            bills: 'bills are not included (approx 120 per month)',
            flatmates: '3 Bulgarian males',
        },
        main_image: "assets/img/properties/property_10/1.jpeg",
        images: ['assets/img/properties/property_10/2.jpeg', 'assets/img/properties/property_10/3.jpeg', 'assets/img/properties/property_10/4.jpeg', 'assets/img/properties/property_10/5.jpeg'],
    }, {
        ...
        description: {
            property: 'Aprtment with 2 floors - 2nd is with 2 bedrooms and bath, 1st floor is with the living room and the kitchen. All furnitures avaialbe. Close to bars/restaurants, transport and markets.',
            period: 'Currently avaialbe',
            bills: 'approximately 80 euro monthly bills',
            flatmates: '1 girl (Bulgarian)',
        },
        main_image: "assets/img/properties/property_6/1.jpg",
        images: ['assets/img/properties/property_6/2.jpg', 'assets/img/properties/property_6/3.jpg', 'assets/img/properties/property_6/4.jpg', 'assets/img/properties/property_6/5.jpg', 'assets/img/properties/property_6/6.jpg', 'assets/img/properties/property_6/7.jpg'],
    },
    {
        ...
        description: {
            ...
            bills: 'All bills included (laundry, dryer and Wi-Fi are paid extra)',
            flatmates: '3 flatmates - 2 x Bulgarians (male and female), 1 х Argentian female',
        },
        main_image: "assets/img/properties/property_5/1.jpg",
        images: ['assets/img/properties/property_5/2.jpg', 'assets/img/properties/property_5/3.jpg', 'assets/img/properties/property_5/4.jpg', 'assets/img/properties/property_5/5.jpg', 'assets/img/properties/property_5/6.jpg', 'assets/img/properties/property_5/7.jpg', 'assets/img/properties/property_5/8.jpg', 'assets/img/properties/property_5/9.jpg', 'assets/img/properties/property_5/10.jpg'],
    },
    {
        ...
        location: 'Gelkingestraat, Groningen',
        description: {
            property: 'A nice studio in the center for subrent - does NOT allow for registration',
            period: '2th October 2023- 2nd March 2024',
            bills: 'All fees included',
            flatmates: 'No roomates/ flatmates',
        },
        main_image: "assets/img/properties/studio2/5.jpg",
        images: ['assets/img/properties/studio2/1.jpg', 'assets/img/properties/studio2/2.jpg', 'assets/img/properties/studio2/3.jpg', 'assets/img/properties/studio2/4.jpg', 'assets/img/properties/studio2/6.jpg', 'assets/img/properties/studio2/7.jpg', 'assets/img/properties/studio2/8.jpg', 'assets/img/properties/studio2/9.jpg', 'assets/img/properties/studio2/10.jpg', , 'assets/img/properties/studio2/11.jpg', , 'assets/img/properties/studio2/12.jpg'],
    },
    ...
    donations: [
        ...
        'Name (optional)',
        'Amount in EUR',
        'Message to be sent to us (optional)',
        'Continue',
        'Pay',
        'Processing...',
        'An unexpected error occured.',
        'Please insert a positive amount',
        'Minimum amount is 2 Euro',
    ...
    privacyPolicyContent: [
        ...
        "We may collect various types of information from you, including but not limited to: Personal information: Your name, email address, phone number, and other contact details.\nProfile information: Details about your preferences, interests, and accommodation requirements.\nCommunication information: Records of correspondence between you and Domakin.\nUsage information: Data about your interactions with the Platform, such as search queries, viewed listings, and user interactions. Family and income declarations: Some information about your family, their income, personal income and any other financial information that might be requested from a landlord or a side that requires it for accomodation lending purposes only.",
        "2. How We Use Your Information",
        "We use the collected information for the following purposes: To facilitate your use of the Platform and provide personalized services.\nTo match you with suitable accommodation listings based on your preferences.\nTo improve our services, user experience, and customer support.\nTo communicate with you about your account, listings, and related updates.\nTo analyze usage patterns and conduct research to enhance our offerings.",
        "3. Sharing of Information",
        "We may share your information in the following circumstances: With accommodation providers: Your profile information may be shared with accommodation owners to facilitate booking and communication.\nWith third-party service providers: We may engage trusted third parties to assist us in providing services, such as payment processing or data analytics.\nLegal compliance: We may disclose information if required by law or to protect our rights, privacy, safety, or property, or that of others.",
        "4. Your Choices",
        ...
        "7. Contracting",
        "For ensuring safety for both sides, we may require you to fill in your details and sign a contract when finances are included. The contract can be stored and use by us for any legal actions that are required if one of the sides fails to comply to what is required by them. Domakin guarantees to provide copy of the contract to its client and to any other side when a request has been delivered and approved.",
