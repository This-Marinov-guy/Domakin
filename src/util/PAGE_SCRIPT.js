const BG = {
    ...
    team: [
        ...
        {
            name: 'Лазар Попов',
            position: 'Агент на недвижими имоти/ Маркетинг Агент',
            about: '26, Студент по Изкуствен Интелект',
            aboutExtra: 'Здравейте, казвам се Лазар и живея в Грониген вече пета година. Познавам градът добре и запознат с намирането и предлагането на имоти в околността, което ме прави идеален за услугите на организацията. Моите интереси са предимно бойни спортове и изкуствен интелект, както менажиране на няколко организации и сдружения. Надявам се да ви бъда от огромна полза!'
        },
        {
            name: 'Сава Попов',
            position: 'Агент на недвижими имоти/ Дизайнер',
            about: '20, Студент по Дизайн на Игри',
            aboutExtra: 'Здравейте, аз съм Сава и съм студент по дизайн на видео игри тук в Гронинген. За мен беше изключително трудно да се сдобия с жилище в града и знам какво направих грешно и какво направих добре. Готов съм да предам опита си на тези, които тепърва започват да търсят квартири/стаи в града. Ще се радвам да ви бъда от полза!'
        },
        {
            name: 'Константин Сонев',
            position: 'Агент на недвижими имоти/ IT Специалист',
            about: '21, Студент по Менджмънт на Строителство',
            aboutExtra: `Здравейте, казвам се Константин и съм студент по мениджмънт на строителство. За мен също беше изключително трудно да се сдобия със стая в Грьонинген и бях изклютелно удовлетворен, когато намерих място с помощта на подбна агенция. Разбира се, и с тях намерих затруднения, заради огромния поток от клинети и скъпи тарифи. Ние от 'Домакин' гарантираме качествено обслужване и добри цени, защото за нас пръв приоритет е да помогнем на хората, които изпитват нашите трудностти. Очаквам да работим заедно!`
        },
        {
...
const EN = {
    ...
    team: [
        ...
        {
            name: 'Lazar Popov',
            position: 'Real Estate Agent/ Marketing Agent',
