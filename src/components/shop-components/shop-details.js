								...
								<div className="row">
									<div className="col-md-6">
										<a href={publicUrl + "assets/img/properties/1.jpg"} data-rel="lightcase:myCollection">
											<img className="mb-30" src={publicUrl + "assets/img/properties/1.jpg"} alt='preview' />
										</a>
										<a href={publicUrl + "assets/img/properties/2.jpg"} data-rel="lightcase:myCollection">
											<img className="mb-30" src={publicUrl + "assets/img/properties/2.jpg"} alt='preview' />
										</a>
									</div>
									<div className="col-md-6">
										<a href={publicUrl + "assets/img/properties/3.jpg"} data-rel="lightcase:myCollection">
											<img className="mb-30" src={publicUrl + "assets/img/properties/3.jpg"} alt='preview' />
										</a>
									</div>
								</div>
							</div>
